...
prev.onclick = function () {
  ...
  for (let i = 0; i<limit; i++)
  {
    ...
    itemNode.className = "list-group-item list-group-item-action";
    itemNode.href = "#";
    ...
    title.innerText = data[page*5+i].name;
    ...
    describe.className = "mb-1";
    describe.innerText = data[page*5+i].description;
    itemNode.appendChild(describe);

    list_group.appendChild(itemNode);
  }
